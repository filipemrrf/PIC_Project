...
\usepackage[backend=bibtex,style=numeric,natbib=true,sorting=none]{biblatex} % Use the bibtex backend with the number citation style
...
\textsc{\Large 2nd Cycle Integrated Project in Engineering Physics}\\[0.5cm] % Thesis type
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \adjustbox{valign=c}{\includegraphics[scale=0.45]{Images/Centra.jpg}}
    \end{subfigure}
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \adjustbox{valign=c}{\includegraphics[scale=0.4]{Images/Grit.png}}
    \end{subfigure}
\end{figure}

...
os.system("./test.exe -IC Convergence/IC-Sin-50p.dat -EQ simple_wave_4th_order -FN Convergence/Out-Sin-50p.dat")
...
os.system("echo Solving the equation using this initial conditions")
os.system("./test.exe -IC Convergence/IC-Sin-100p.dat -EQ simple_wave_4th_order -FN Convergence/Out-Sin-100p.dat")
...
os.system("echo Solving the equation using this initial conditions")
os.system("./test.exe -IC Convergence/IC-Sin-200p.dat -EQ simple_wave_4th_order -FN Convergence/Out-Sin-200p.dat")

os.system("echo \n")

os.system("echo Calculating the convergence")
os.system("python3 Convergence_Tests/Convergence_Test.py Convergence/Out-Sin-50p.dat Convergence/Out-Sin-100p.dat Convergence/Out-Sin-200p.dat -SX 0.02 0.01 0.005 -NP 50 100 200 -FN Convergence/ -E 1 16")
